...
PHOTO_DIRECTORY = getpwuid(getuid()).pw_dir + "/Pictures/Wallpapers/"
...
def choosePic():
    ...
    all_pics = listdir(PHOTO_DIRECTORY)
    ...
    if isleap(current_year) and today > 60:
        today = today - 1
    ...
    for pic in all_pics:
        ...
        date_number_on_pic = sub('\.[a-zA-Z]*','',pic)
...
def setWallpaper(photoname):
    ...
    call(["gsettings", "set", "org.gnome.desktop.background", "picture-uri", long_file])
